export function WhatsAppButton({ phone }: { phone?: string | null }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-30 size-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-elegant hover:scale-110 transition-transform"
    >
